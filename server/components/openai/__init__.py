...
def openai_completion(
    ...
    Args:
        ...
        suffix (Optional[str]): The suffix that comes after a completion of inserted text. Defaults to None.
...
model_registry.register(
    ...
    tags=[
        model_registry.tags_types.LLM,
        model_registry.tags_types.GPT,
    ],
)
