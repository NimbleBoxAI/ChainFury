...
def get_prompts_from_chatbot_id(chatbot_id: str):
    prompts = []
    db = db_session()
...
def get_prompts_with_user_rating_from_chatbot_id(chatbot_id: str):
    prompts = []
    db = db_session()
...
def get_prompts_with_chatbot_user_rating_from_chatbot_id(chatbot_id: str):
    prompts = []
    db = db_session()
...
def get_prompts_with_openai_rating_from_chatbot_id(chatbot_id: str):
    prompts = []
    db = db_session()
